                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div id="radius-inputs" style="display: none;">
                                ...
                                <div class="input-group input-group-merge mb-4">
                                    <div class="form-floating form-floating-outline">
                                        <input type="number" step="any" name="radius" id="radius" class="form-control" placeholder="Radius (meter)">
...
@push('scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function toggleRadiusInputs() {
                radiusInputs.style.display = typeSelect.value == '1' ? 'block' : 'none';
            }
            ...
            toggleRadiusInputs(); // initial load
        });
