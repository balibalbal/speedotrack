...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <strong>Tambah Device</strong> <a href="{{ route('devices.index') }}" class="btn rounded-pill btn-dark waves-effect waves-light"><i class="mdi mdi-arrow-left-circle me-sm-1"></i> Kembali</a>
        </div>
                      ...
                      <div class="input-group input-group-merge mb-4">
                        ...
                        <div class="form-floating form-floating-outline">
                          <input
                            ...
                            name="imei"
                            value="{{ old('imei') }}" class="form-control @error('imei') is-invalid @enderror"/>
                      ...
                      <div class="input-group input-group-merge mb-4">
                        ...
                        <div class="form-floating form-floating-outline">
                          <input
                            ...
                            name="sim_number" value="{{ old('sim_number') }}" class="form-control phone-mask @error('seluler') is-invalid @enderror" />
