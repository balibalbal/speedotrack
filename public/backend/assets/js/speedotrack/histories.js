...
function setSpeedLevel(level) {
    const map = {
        1: { delay: 2000, label: '0.5x', color: '#198754' },
        2: { delay: 1200, label: '0.75x', color: '#0dcaf0' },
        3: { delay: 600,  label: '1x',    color: '#0d6efd' },
        4: { delay: 300,  label: '1.5x',  color: '#ffc107' },
        5: { delay: 150,  label: '2x',    color: '#dc3545' }
    };
    ...
    // 🔥 GANTI WARNA SLIDER (WORK 100%)
    const range = document.getElementById('speedRange');
    range.style.setProperty('--range-color', cfg.color);
